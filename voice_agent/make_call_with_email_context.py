#!/usr/bin/env python
"""Make an outbound call with FULL context: customer data + emails + attachments."""
...
from voice_agent.app.vapi_client import initiate_outbound_call
from voice_agent.app.config import settings, INSURANCE_PROSPECT_SYSTEM_PROMPT
from voice_agent.app.db import get_db, get_customer_by_id, get_table_name
from voice_agent.app.context_manager import ContextManager

# Import email context manager

#!/usr/bin/env python
"""Test simple embedding optimization."""
...
from backend.voice_agent.services.embedding_cache import get_cache_stats, get_redis_client
import logging
...
def test_llm_providers():
    ...
    from backend.voice_agent.llm_providers import get_llm_provider
...
def test_embedding_cache():
    ...
    from backend.voice_agent.embedding_cache import (
        get_cache_key, 
        cache_embedding, 
...
def test_modal_client():
    ...
    from backend.voice_agent.modal_client import get_modal_client

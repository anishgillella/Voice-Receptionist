...
try:
    ...
    from backend.email_agent.config import email_settings
...
try:
    ...
    from backend.email_agent.models import SendEmailRequest, FetchEmailsRequest
    print("    ✅ models")
except Exception as e:
    print(f"    ❌ models: {e}")
    sys.exit(1)
...
try:
    ...
    from backend.email_agent.gmail_client import GmailClient
...
try:
    ...
    from backend.email_agent.s3_client import S3Client
...
try:
    ...
    from backend.email_agent.document_processor.document_processor import DocumentProcessor
...
try:
    print("  Loading db...")
    from backend.email_agent.db import EmailDatabase
...
try:
    ...
    from backend.email_agent.main import app
